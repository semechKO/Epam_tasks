...
public class MusicDisk  {
    ...
    public static void main(String[] args) throws DiskTypeException, ParseException, IOException, NoSuchMethodException {
        ...
        //тут нужно путь до файла tracks.txt указать, чтобы не было ошибки
        tracks.createTrackListFromFile("D:\\Cloud\\OneDrive\\проганье\\tests_epam\\MusicDisk_02\\src\\core\\tracks.txt");
